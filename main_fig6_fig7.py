...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun  4 20:59:32 2021
...
for index, beta in enumerate(Beta):
    for index_prime, lambda_ in enumerate(Lambda) :
        ...
        mean_px_6[index_prime][index], mean_py_6[index_prime][index], mean_pz_6[index_prime][index]= modeling_fig6(params6) 
        mean_px_7[index_prime][index], mean_py_7[index_prime][index], mean_pz_7[index_prime][index]= modeling_fig7(params7) 
